...
import Controladores.controlTransporte;
...
public class dlgTransporte extends javax.swing.JDialog {
    ...
    public dlgTransporte(java.awt.Frame parent, boolean modal) {
        ...
        controlTransporte.listTransporte(jTable1);
    }
    ...
    private void initComponents() {
        ...
        jButton7.setToolTipText("Nuevo Transporte");
        ...
        jButton8.setToolTipText("Borrar Transporte");
        ...
        jButton9.setToolTipText("Modificar Transporte");
        ...
        jButton10.setToolTipText("Grabar Transporte");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        String cod = GestionarTransporte.getCodigo();
        jLabel1.setText(cod);
        jTextField2.setText("");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        jButton9.setEnabled(false);
        jTextField2.setEnabled(false);
        controlTransporte.delTransporte();
        limpiarCampos();
        CabecerasTablas.limpiarTablas(jTable1);
        controlTransporte.listTransporte(jTable1);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        // TODO add your handling code here:
        controlTransporte.actTransporte();
        jButton9.setEnabled(false);
        jButton8.setEnabled(false);
        jTextField2.setEnabled(false);
        limpiarCampos();
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        controlTransporte.addTransporte();
        jButton10.setEnabled(false);
        jTextField2.setEnabled(false);
        limpiarCampos();
        CabecerasTablas.limpiarTablas(jTable1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        cargarComboBox.cargar(dlgGestClientes.cbTransporte, "SELECT * FROM transporte WHERE tra_indicador='S'");
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgTransporte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                dlgTransporte dialog = new dlgTransporte(new javax.swing.JFrame(), true);
