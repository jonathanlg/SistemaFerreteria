...
public class dlgUnidad extends javax.swing.JDialog {
    ...
    public dlgUnidad(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cabe.unidades(jTable1);
        controlUnidad.lisUnidades(jTable1);
    }
    ...
    private void initComponents() {
        ...
        jButton7.setToolTipText("Nuevo Unidades");
        ...
        jButton8.setToolTipText("Borrar Unidades");
        ...
        jButton9.setToolTipText("Modificar Unidades");
        ...
        jButton10.setToolTipText("Grabar Unidades");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        String cod = GestionarUnidad.getCodigo();
        jLabel1.setText(cod);
        jTextField2.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgUnidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                dlgUnidad dialog = new dlgUnidad(new javax.swing.JFrame(), true);
