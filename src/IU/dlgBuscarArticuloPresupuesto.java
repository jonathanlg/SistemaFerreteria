...
public class dlgBuscarArticuloPresupuesto extends javax.swing.JDialog {

    CabecerasTablas cabe = new CabecerasTablas();
    DetalleSalida ds;
    Articulo art;
    public dlgBuscarArticuloPresupuesto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        {
            controlPresupuesto.selecArticulo();
            this.dispose();
            dlgPresupuestos.txtCant.requestFocus();
            dlgPresupuestos.txtCant.selectAll();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgBuscarArticuloPresupuesto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                dlgBuscarArticuloPresupuesto dialog = new dlgBuscarArticuloPresupuesto(new javax.swing.JFrame(), true);
