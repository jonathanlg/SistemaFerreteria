...
public class dlgBuscarArticuloFactura extends javax.swing.JDialog {

    CabecerasTablas cabe = new CabecerasTablas();
    public dlgBuscarArticuloFactura(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(evt.getClickCount()==2)
        {
            ...
            this.dispose();
            dlgFactura.txtCant.requestFocus();
            dlgFactura.txtCant.selectAll();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgBuscarArticuloFactura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgBuscarArticuloFactura dialog = new dlgBuscarArticuloFactura(new javax.swing.JFrame(), true);
