...
public class dlgFinCompra extends javax.swing.JDialog {

    public dlgFinCompra(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Finalizar la Compra");

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Efectivo", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N

        txtAbono.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtAbono.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtAbono.setText("0.0");

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel1.setText("Pagado en Efectivo :");
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(txtAbono, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(28, 28, 28))
        );
        ...
        jLabel3.setText("Resumen de Pago");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            controlCompra.addCompra();
            controlCompra.addDetalleCompra();
            dlgCompras.btnSalir.doClick();
            frmPrincipal.btnCompras.doClick();
            this.dispose();
        } catch (Exception e) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        int rpta = Mensajes.confirmar("Desea cancelar la Compra");
        if(rpta==0)
        {
            dlgCompras.btnSalir.doClick();
            frmPrincipal.btnCompras.doClick();;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgFinCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                dlgFinCompra dialog = new dlgFinCompra(new javax.swing.JFrame(), true);
